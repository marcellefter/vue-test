# Junior Javascript Developer (Vue)

It's necessary to create Vue JS application, using only [Typescript](https://www.typescriptlang.org/), [Vue Router](https://router.vuejs.org/) and [Vuex](https://vuex.vuejs.org/), that will show list of products and gets possibility for user adding desired products in his cart.
...
1. Start client using `yarn serve:client`
   it will start on [localhost:8080](http://localhost:8080)
